...
const taskSchema = new mongoose.Schema(
  {
    ...
    titulo: {
      ...
      maxlength: [
        MAX_LENGTH,
        `El título no debe exceder los ${MAX_LENGTH} caracteres`,
      ],
    },
    ...
    descripcion: {
      ...
      minlength: [
        MIN_DESC_LENGTH,
        `La descripción debe tener al menos ${MIN_DESC_LENGTH} caracteres`,
      ],
      maxlength: [
        MAX_DESC_LENGTH,
        `La descripción no debe exceder los ${MAX_DESC_LENGTH} caracteres`,
      ],
    },
